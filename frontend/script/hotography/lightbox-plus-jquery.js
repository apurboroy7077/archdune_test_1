...
// Project Details pag read moe info script
...
// Project Details shear script

const shearBtn = document.querySelector(".c-sin-pro-title-shear2400");
const shearicon = document.querySelector(".socil-shear-icon");

// shearBtn.addEventListener("click", function () {
//   shearicon.classList.toggle("socil-shear-icon-show");
// });
...
function projectShear() {
  // const ParamountConcordImg = ;

  let postURL = encodeURI(document.location.href);
  let posttitle = encodeURIComponent("ArchDune Projects");
  // let postImgs = encodeURIComponent(
  //   document.querySelector(".Paramount-concord-img").href
  // );
