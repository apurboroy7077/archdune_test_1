...
const renderProjectDetails2 = (projectData: receivedProjectDataType) => {
  const projectDescriptionDiv2 = document.getElementsByClassName(
    "project-description-2-div-selector"
  )[0] as HTMLDivElement;
  const htmlCode = `
