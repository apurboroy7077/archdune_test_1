const demoProjectData = [
    {
        ...
        data: {
            ...
            projectImageSrc: "/frontend/images/project_page_img/DiptenuSaha/01_cluster view_cover photo.jpg",
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/02_location%20map.jpg",
                        },
                    ],
                },
                {
                    fieldName: "Daily Activity",
                    fieldDescription: "This community earns their bread by fishing. Most of the time in a day when they are not on sea for fishing, they are busy making their fishing nets, repairing them, looking after their fishing boats and arranging them in various designs.",
                    fieldImages: [
                        {
                            caption: "Daily Activities © Diptenu Saha | PUST",
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/03_daily%20activities.jpg",
                        },
                    ],
                },
                {
                    fieldName: "Concept",
                    fieldDescription: "In this community (জলদাস), 100% current people belong to the Hindu religion. In their lifestyle, the most colorful and vibrant things are the festivals which they celebrate through different puja and occasions. So, the idea is to give proper space around the existing temples to celebrate their puja and other festivals to create a sense of belongingness and preserve their rituals and traditions.",
                    fieldImages: [
                        {
                            caption: "Concept © Diptenu Saha | PUST",
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/04_conept.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/05_occupent.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/06_master%20plan.jpg",
                        },
                    ],
                },
                {
                    ...
                    extraField: [
                        {
                            fieldName: "",
                            fieldDescription: "The module can be extended vertically in future. It can be extended up to 02 or 03 more bedrooms if needed.",
                            fieldImages: [
                                {
                                    caption: "Module Plan © Diptenu Saha | PUST",
                                    imageSrc: "/frontend/images/project_page_img/DiptenuSaha/08_module%20plan.jpg",
                                },
                                {
                                    caption: "Section & Structural Details © Diptenu Saha | PUST",
                                    imageSrc: "/frontend/images/project_page_img/DiptenuSaha/09_section%20&%20structural%20details.jpg",
                                },
                            ],
                        },
                    ],
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/10_render%20view.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/11_fish%20market.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/12_local%20market%20&%20multipurpose%20hall.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/13%20_pre-primary%20school.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/14_community%20clinic.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/15_activities%20of%20ghat.jpg",
                        },
                        {
                            caption: "Festival (ত্রয়োদশ পার্বণের মহাউৎসব) © Diptenu Saha | PUST",
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/16_festival.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/17_aerial%20view.jpg",
                        },
                    ],
                },
                {
                    ...
                    fieldImages: [
                        {
                            ...
                            imageSrc: "/frontend/images/project_page_img/DiptenuSaha/18_model.jpg",
                        },
                    ],
                },
            ],
