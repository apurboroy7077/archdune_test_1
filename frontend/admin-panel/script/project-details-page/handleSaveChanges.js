import { KEYNAME_OF_ADMIN_TOKEN_IN_LOCALSTORAGE, KEYNAME_OF_OPENED_PROJECT_ID_IN_ADMIN_PANEL, } from "../../../data/variables/Environment.js";
import { ARCHDUNE_UPDATE_PROJECT_DATA_API, SERVER_URL, } from "../../../data/variables/apiAdresses.js";
import ar7Fetch from "../../../script/utils/custom-functions/ar7Fetch.js";
import wait from "../../../script/utils/custom-functions/wait.js";
import showSavingButton, { showSavingFailedButton, showSavingSuccessfulButton, } from "./showSavingButton.js";
const handleSaveChanges = (projectData) => {
