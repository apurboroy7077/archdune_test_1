...
const checkPasswordOfAdminPanelIndexPage = () => {
  const indexForm = document.getElementsByClassName(
    "admin-index-form-selector"
  )[0] as HTMLFormElement;
  const errorMessageDiv = document.getElementsByClassName(
    "error-message-div-selector"
  )[0] as HTMLDivElement;
